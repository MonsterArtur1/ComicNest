...
Now open **http://localhost:8080/** in your browser, open the **⚙ Admin** panel and click
**Scan Library** there. The first scan of a large collection takes a while, because covers are
...
open `/admin` and click **Scan Library** there.
